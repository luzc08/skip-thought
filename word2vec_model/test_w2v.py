...
print model1.most_similar(['cross-device', 'interaction'], [], topn=10)
print model2.most_similar(['cross-device', 'interaction'], [], topn=10)
print model3.most_similar(['cross-device', 'interaction'], [], topn=10)
